        ...
        <header>
            <nav class="fixed top-0 w-full z-50">
                        <div class="w-full bg-gray-overlay-95">
                            <div class="block w-full xl:max-w-screen-xl xl:mx-auto">
                                <div class="flex items-center lg:space-x-6 justify-between transition-colors duration-75">
                                    <div class="hidden lg:inline-block text-center"><a href="/thelanding/#gallery" class="py-5 block text-lg font-semibold text-white uppercase hover:text-green-brighter">Gallery</a></div>
                                    <div class="hidden lg:inline-block text-center"><a href="/thelanding/#community" class="py-5 block text-lg font-semibold text-white uppercase hover:text-green-brighter">Community Features</a></div>
                                    <div class="hidden lg:inline-block text-center"><a href="/thelanding/#amenities" class="py-5 block text-lg font-semibold text-white uppercase hover:text-green-brighter">Amenities</a></div>
                                    <div class="hidden lg:inline-block text-center"><a href="/thelanding/#floorPlans" class="py-5 block text-lg font-semibold text-white uppercase hover:text-green-brighter">Floor Plans</a></div>
                                    <div class="flex-1 lg:px-4 py-5 lg:mx-4 cursor-pointer"><a href="/thelanding/"><img src="<?php echo get_template_directory_uri() ?>/images/thelanding-logo-white.svg" class="h-16 mx-auto" alt="The Landing logo" /></a></div>
                                    <div class="hidden lg:inline-block text-center"><a href="/thelanding/#map" class="py-5 block text-lg font-semibold text-white uppercase hover:text-green-brighter">Neighborhood</a></div>
                        ...
                        <div class="relative">
                            ...
                            <div class="border-b border-orange"><a href="/thelanding/#gallery" class="block py-4 px-6 text-white">Gallery</a></div>
                            <div class="border-b border-orange"><a href="/thelanding/#community" class="block py-4 px-6 text-white">Community Features</a></div>
                            <div class="border-b border-orange"><a href="/thelanding/#amenities" class="block py-4 px-6 text-white">Amenities</a></div>
                            <div class="border-b border-orange"><a href="/thelanding/#floorPlans" class="block py-4 px-6 text-white">Floor Plans</a></div>
                            <div class="border-b border-orange"><a href="/thelanding/#map" class="block py-4 px-6 text-white">Neighborhood</a></div>
                            ...
                            <div class="border-b border-orange" x-data="{ open: false }">
                                ...
                                <div class="border-b border-orange"><a href="/thelanding/#contact" class="block py-4 px-6 text-white">Contact Us</a></div>
                    ...
                    <div class="hidden lg:inline-block fixed right-0 z-40" style="top: 12rem;">
                        <div class="inline-flex flex-col">
                            <div><a href="/thelanding/#contact" class="block py-3 px-16 text-lg uppercase font-semibold border border-black rounded-tl-md border-r-0 text-white bg-orange hover:bg-orange-dark transition-colors duration-100">Contact Us</a></div>
