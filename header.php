                        ...
                        <div class="w-full bg-green-overlay-90">
                            <div class="block w-full xl:max-w-screen-xl xl:mx-auto">
                                <div class="flex items-center lg:space-x-6 justify-between transition-colors duration-75">
                                    <div class="hidden lg:inline-block text-center"><a href="#" x-on:click.prevent="window.scroll({ top: ($refs.gallery.offsetTop - 104), left: 0, behavior: 'smooth' })" :class="{ 'border-teal-bright' : active === 'gallery' }" class="block text-lg font-semibold text-white uppercase border-b-4 border-transparent hover:border-orange-bright">Gallery</a></div>
                                    <div class="hidden lg:inline-block text-center"><a href="#" x-on:click.prevent="window.scroll({ top: ($refs.community.offsetTop - 104), left: 0, behavior: 'smooth' })" :class="{ 'border-teal-bright' : active === 'community' }" class="block text-lg font-semibold text-white uppercase border-b-4 border-transparent hover:border-orange-bright">Community Features</a></div>
                                    <div class="hidden lg:inline-block text-center"><a href="#" x-on:click.prevent="window.scroll({ top: ($refs.amenities.offsetTop - 104), left: 0, behavior: 'smooth' })" :class="{ 'border-teal-bright' : active === 'amenities' }" class="block text-lg font-semibold text-white uppercase border-b-4 border-transparent hover:border-orange-bright">Amenities</a></div>
                                    <div class="hidden lg:inline-block text-center"><a href="#" x-on:click.prevent="window.scroll({ top: ($refs.floorPlans.offsetTop - 152), left: 0, behavior: 'smooth' })" :class="{ 'border-teal-bright' : active === 'floorPlans' }" class="block text-lg font-semibold text-white uppercase border-b-4 border-transparent hover:border-orange-bright">Floor Plans</a></div>
                                    ...
                                    <div class="hidden lg:inline-block text-center"><a href="#" x-on:click.prevent="window.scroll({ top: ($refs.map.offsetTop - 100), left: 0, behavior: 'smooth' })" :class="{ 'border-teal-bright' : active === 'map' }" class="block text-lg font-semibold text-white uppercase border-b-4 border-transparent hover:border-orange-bright">Neighborhood</a></div>
